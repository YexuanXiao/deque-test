...
int main(int, char**) {
  ...
  }
  {
    ...
    bizwen::deque<int, A> c1(a1, a1 + sizeof(a1) / sizeof(a1[0]), A(1, 1));
    bizwen::deque<int, A> c2(a2, a2 + sizeof(a2) / sizeof(a2[0]), A(1, 2));
    swap(c1, c2);
    assert((c1 == bizwen::deque<int, A>(a2, a2 + sizeof(a2) / sizeof(a2[0]))));
    assert(c1.get_allocator().get_id() == 1);
    assert((c2 == bizwen::deque<int, A>(a1, a1 + sizeof(a1) / sizeof(a1[0]))));
  ...
  }
  {
    ...
    bizwen::deque<int, A> c1(a1, a1 + sizeof(a1) / sizeof(a1[0]), A(1));
    bizwen::deque<int, A> c2(a2, a2 + sizeof(a2) / sizeof(a2[0]), A(2));
    swap(c1, c2);
    assert((c1 == bizwen::deque<int, A>(a2, a2 + sizeof(a2) / sizeof(a2[0]))));
  ...
  }
  {
    ...
    bizwen::deque<int, A> c1(a1, a1 + sizeof(a1) / sizeof(a1[0]), A());
    bizwen::deque<int, A> c2(a2, a2 + sizeof(a2) / sizeof(a2[0]), A());
    swap(c1, c2);
    assert((c1 == bizwen::deque<int, A>(a2, a2 + sizeof(a2) / sizeof(a2[0]))));
