...
int main(int, char**) {
  {
    ...
    testNI<bizwen::deque<int> >(1500, 2000, 1000);
#if TEST_STD_VER >= 11
    test_move<bizwen::deque<MoveOnly, limited_allocator<MoveOnly, 2000> > >();
#endif
  }
#if TEST_STD_VER >= 11
  {
    ...
    testNI<bizwen::deque<int> >(1500, 2000, 1000);
    test_move<bizwen::deque<MoveOnly, min_allocator<MoveOnly> > >();
  }
  {
    int rng[]   = {0, 1, 2, 3, 1023, 1024, 1025, 2047, 2048, 2049};
    const int N = sizeof(rng) / sizeof(rng[0]);
    ...
    testNI<bizwen::deque<int> >(1500, 2000, 1000);
    test_move<bizwen::deque<MoveOnly, safe_allocator<MoveOnly> > >();
  }
#endif
